...
<%
	...
	if (session.getAttribute("id") != null) {
		...
		classtitle = request.getParameter("bbs3ClassTitle");
		classteacher = request.getParameter("bbs3ClassTeacher");
	}
%>
<body>
	<!-- nav bar -->
	...
	<div id="body">
		...
		<div class="container">
			<br> <br>
			<form action="bbs3ModController" style="width: 70% ; margin-left: 200px;">
				<input type="hidden" name="num" value=<%=no %>>
					<div class="form-group">
						<label for="exampleFormControlInput1">제목</label> <input
							type="text" class="form-control" id="title" value=<%=title %>
					...
					<button type="submit" class="btn btn-success" id="modBtn">완료</button>
				</form>
