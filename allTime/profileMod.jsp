							...
							<div class="panel-body">
								<div class="row">
									...
									<div class=" col-md-9 col-lg-9 ">
										<form method="get" action="modController">
											<table class="table table-user-information">
												<tbody style="font-family: 'Hanna'; text-align: center; color: #112f41;">
													<tr>
														<td>아이디:</td>
														<td><%=id%></td>
													</tr>
                                 ...
                                 -->
													...
													<tr>
														...
														<td><input type="text" readonly="readonly"
															name="memberCollege" value="<%=college%>"></td>
													</tr>
											...
											<br>
											<button type="submit" class="btn btn-primary" id="btn">수정완료</button>
										</form>
									</div>
								</div>
							</div>
